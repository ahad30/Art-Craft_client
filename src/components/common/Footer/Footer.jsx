    ...
    <div className="mx-auto max-w-7xl space-y-8 px-4 py-16 sm:px-6 lg:space-y-16 lg:px-8">
      <div className="grid grid-cols-1 text-center lg:text-left gap-8 lg:grid-cols-3">
        <div>
          ...
          Discover an exceptional luxurious houses and resorts tailored for you!
          </p>
            </div> 
      ...
      <p className="text-xs text-gray-500 text-center">&copy; 2024. Golden Crown Luxury. All rights reserved.</p>
    </div>
  </footer>
  );
};
